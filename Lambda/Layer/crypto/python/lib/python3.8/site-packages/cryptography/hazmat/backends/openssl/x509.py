...
class _Certificate(object):
    def __init__(self, backend, x509_cert):
        ...
        if version == 0:
            ...
            raise x509.InvalidVersion(f"{version} is not a valid X509 version", version)
    ...
    def signature_hash_algorithm(self):
        ...
        try:
            ...
            raise UnsupportedAlgorithm(f"Signature algorithm OID:{oid} not recognized")
...
class _CertificateSigningRequest(object):
    ...
    def get_attribute_for_oid(self, oid):
        ...
        if asn1_type.type not in (
            ...
            raise ValueError(f"OID {oid} has a disallowed ASN.1 type: {asn1_type.type}")
...
class _SignedCertificateTimestamp(object):
    ...
    def __eq__(self, other):
        return (
            ...
            if isinstance(other, _SignedCertificateTimestamp)
            else NotImplemented
        )
