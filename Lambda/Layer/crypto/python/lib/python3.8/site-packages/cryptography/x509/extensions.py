...
class PolicyInformation(object):
    ...
    def __hash__(self):
        pq = None if self.policy_qualifiers is None else tuple(self.policy_qualifiers)
...
class NameConstraints(object):
    ...
    def __hash__(self):
        ...
        es = None if self.excluded_subtrees is None else tuple(self.excluded_subtrees)
        return hash((ps, es))
